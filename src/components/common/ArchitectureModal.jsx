      ...
      <div className="modal-dialog modal-lg">
        ...
        <div className="modal-body arch-modal-body">
          ...
          <div className="arch-banner">
            <span className="arch-banner-title">EE Capstone Viva Demonstration Reference</span>
          ...
          {/* Viva Defense Tip */}
          <div className="viva-tip-box">
            <ShieldCheck size={18} className="text-primary" />
            <div className="viva-tip-text">
              <strong>Viva Defense Tip:</strong> Emphasize the Haversine distance matrix between predefined depots and line assets to defend the resilience of zero-GPS static coordinates under extreme weather storm interference.
            </div>
          </div>
        </div>
